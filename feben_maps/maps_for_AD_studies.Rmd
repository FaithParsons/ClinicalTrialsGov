...
Integrating Faith's rds to add lat and longs to dataset!
```{r Part 8, getting the lat and long rds}
...
## get the rds that has all locations and their associated lat and long coordinates
