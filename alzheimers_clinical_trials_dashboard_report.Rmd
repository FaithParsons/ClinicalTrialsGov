...
[Gantt chart](https://en.wikipedia.org/wiki/Gantt_chart) was created for those US studies with available starting and ending dates to visualize the landscape of Alzheimers Disease clinical trials over time.  
...
# Results  
The Gantt chart (**Figure 3**) and Age Eligibility plot (**Figure 4**) were created to visualize, for currently recruiting interventional phase 3 trials, how long each trial is expected to run, and the age range of target participants.   
